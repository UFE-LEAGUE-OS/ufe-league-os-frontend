...
import styles from "./UnionAdminPaymentApprovals.module.css";
...
export default function UnionAdminPaymentApprovals() {
    ...
    const sortedTransactions = useMemo(() => {
        return [...filteredTransactions].sort((a, b) => {
            const aValue = a[sort.key as keyof ApprovalTransaction];
            const bValue = b[sort.key as keyof ApprovalTransaction];
        ...
        <section className={styles.page}>
            <header className={styles.header}>
                <div>
                    ...
                    <p>
                        {pendingCount} pending approval{pendingCount === 1 ? "" : "s"} requiring finance officer
                        review.
                    </p>
                </div>
            </header>
            ...
            {isLoading ? <div className={styles.alertBanner}>Loading approvals…</div> : null}
                        ...
                        {paginatedTransactions.length > 0 ? (
                                ...
                                <tr key={tx.reference}>
                                    ...
                                    <td>
                                        <div className={styles.actionButtons}>
                                            ...
                                            <button type="button" className={styles.actionApprove} title="Approve">
                            ...
                            <tr>
                                <td colSpan={7} className={styles.emptyRow}>
                                    No payment approvals found for the selected filters.
                                </td>
                            </tr>
                        )}
                    </tbody>
