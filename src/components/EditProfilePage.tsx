        ...
        <div className="profile-section">
                  ...
                  <div className="edit-profile-card">
                    <fieldset className="edit-profile-field">
                      ...
                      <div className="edit-photo-section">
                        ...
                        <img src={preview || profile.image} className="edit-profile-image" alt="preview"
          ...
          {activeTab === "settings" && (
            <fieldset className="settings-section">
              ...
              <div className="field field-checkbox">
                <input
                  id="notifyOnClubEvents"
                  type="checkbox"
                  name="notifyOnClubEvents"

                />
                <label htmlFor="notifyOnClubEvents">
                  Notify me about club events
                </label>
              </div>

              <div className="field field-checkbox">
                <input
                  id="notifyOnDirectMessages"
                  type="checkbox"
                  name="notifyOnDirectMessages"

                />
                <label htmlFor="notifyOnDirectMessages">
